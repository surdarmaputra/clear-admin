...
/**
 * A page-sized dataset is no test of a server-side table, so this one is 48
 * rows. Generated deterministically at build time — no seed, no drift between
 * builds, and the demo stays a static file.
 */
const customers = [
  'Ada Lovelace',
  'Grace Hopper',
